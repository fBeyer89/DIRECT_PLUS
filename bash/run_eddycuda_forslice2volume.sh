...
then 
bval=`ls /data/p_02205/TIME0/${subj}/brain/${subj}_DTI_high_iso*.bval`
else
...
if [ ! -d /data/pt_02205/Data/wd/direct_preproc/_subject_${subj}/dicom_convert/ ];
then 
bvec=`ls /data/p_02205/TIME0/${subj}/brain/${subj}_DTI_high_iso*.bvec`
else 
...
if [ -d /data/pt_02205/Data/wd/T18/direct_preproc/dwi_preproc/distor_correct/_subject_${subj}/ ]; then


bval=`ls /data/pt_02205/Data/wd/T18/direct_preproc/_subject_${subj}/dicom_convert/*.bval`
if [ ! -f $bval ];
then 
bval=`ls /data/p_02205/TIME18/${subj}/brain/${subj}_DTI_high_iso*.bval`
fi
bvec=`ls /data/pt_02205/Data/wd/T18/direct_preproc/_subject_${subj}/dicom_convert/*.bvec`
if [ ! -f $bvec ];
then 
bvec=`ls /data/p_02205/TIME18/${subj}/brain/${subj}_DTI_high_iso*.bvec`
fi



input=`ls /data/pt_02205/Data/wd/T18/direct_preproc/dwi_preproc/distor_correct/_subject_${subj}/unring/*_denoised_unringed.nii.gz`
...
eddy_cuda9.1 --cnr_maps --ff=10.0 --acqp=/data/pt_02205/Data/wd/T18/direct_preproc/dwi_preproc/distor_correct/_subject_${subj}/mk_acq/acqparams_dwi.txt --bvals=${bval} --bvecs=${bvec} --imain=${input} --index=/data/pt_02205/Data/wd/T18/direct_preproc/dwi_preproc/distor_correct/_subject_${subj}/mk_index/index.txt --mask=${mask} --out=/data/pt_02205/Data/wd/T18/direct_preproc/dwi_preproc/distor_correct/_subject_${subj}/eddy/eddy_corrected_slicetovol --repol --residuals --niter=5 --fwhm=10,0,0,0,0 --mporder=6 --s2v_niter=5 --s2v_lambda=1 --s2v_interp=trilinear --slspec=/data/pt_02205/Analysis/Preprocessing/bash/slsspec.txt
else

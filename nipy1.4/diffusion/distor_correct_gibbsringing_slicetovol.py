...
eddy-openmp from FSL with replace outliers option but slice-to-volume
correction  (yet this was too slow, therefore changed to bash script)
-------------------------------------------------------------------------
'''
...
def create_distortion_correct():
    ...
    eddy.inputs.slice2vol_interp="spline"
    eddy.inputs.mporder=4
